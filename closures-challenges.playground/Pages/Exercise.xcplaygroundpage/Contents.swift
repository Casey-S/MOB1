...
func doesApply(a: Int, b: Int, testFunction: (Int, Int) -> Bool ) -> Bool {
 ...
 */
func areBothDivisableByThree(a: Int, b: Int) -> Bool {
 ...
 */
doesApply(a: 47685, b: 344832, testFunction: areBothDivisableByThree)
/*
 ...
 */
doesApply(a: 47685, b: 344832, testFunction: { (a: Int, b: Int) -> Bool in
    return (a % 3) == 0 && (b % 3) == 0 ? true : false
})
/*
 ...
 */
doesApply(a: 42, b: 42) { (a: Int, b: Int) -> Bool in
